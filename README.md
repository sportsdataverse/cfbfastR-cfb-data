...
- `python/espn_cfb_30_adv_player_usage_creation.py`
- `python/espn_cfb_31_adv_position_group_usage_creation.py`
- `python/espn_cfb_32_adv_tackles_creation.py`
- `python/espn_cfb_33_adv_position_group_tackles_creation.py`
- `python/espn_cfb_34_adv_team_usage_creation.py`
- `python/espn_cfb_35_adv_drive_scripting_creation.py`
- `python/espn_cfb_36_adv_st_kickers_creation.py`
- `python/espn_cfb_37_adv_st_punters_creation.py`
...
- `python/espn_cfb_53_usage_position_group_tackles_creation.py`
- `python/espn_cfb_54_usage_teams_creation.py`
- `python/espn_cfb_55_usage_drive_scripting_creation.py`
- `python/espn_cfb_56_usage_st_kickers_creation.py`
- `python/espn_cfb_57_usage_st_punters_creation.py`
