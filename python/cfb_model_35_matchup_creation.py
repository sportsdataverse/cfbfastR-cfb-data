...
read by the stage-41/42 dataset builders.
...
Example:
    Forwarded straight through to the package CLI::
        ...
        "$PY" python/cfb_model_35_matchup_creation.py train-scoring-opp --seasons 2014-2024 --out-dir python/cfb_model_build/cfb_matchup/artifacts
"""
