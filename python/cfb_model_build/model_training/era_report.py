...
Run::
    ...
    python -m cfb_model_build.model_training.era_report --artifacts artifacts --out artifacts/era_report.md
"""
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="cfb_model_build.model_training.era_report")
