...
Usage:
    uv run python -m cfb_model_build.model_training.fourth_down.cli train-fd \\
...
def main(argv=None) -> int:
    ...
    if args.cmd == "train-fd":
        ...
        from cfb_model_build.model_training.ingest import _read_final_plays  # shared final.json reader
