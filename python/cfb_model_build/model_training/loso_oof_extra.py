...
Run::
    ...
    python -m cfb_model_build.model_training.loso_oof_extra --artifacts artifacts \
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="cfb_model_build.model_training.loso_oof_extra")
