...
Run::
    ...
    python -m cfb_model_build.model_training.punt_distribution --pbp artifacts/pbp_full.parquet \
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="cfb_model_build.model_training.punt_distribution")
