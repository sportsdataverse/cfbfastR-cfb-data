...
Usage:
  uv run python -m cfb_model_build.pregame_wp build-boxes  --seasons 2012:2020 --out cfb/pregame_wp/boxes/
  uv run python -m cfb_model_build.pregame_wp train        --boxes cfb/pregame_wp/boxes/ --out cfb/pregame_wp/
  uv run python -m cfb_model_build.pregame_wp predict-matchup --home "LSU" --away "Clemson" --year 2019
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.cmd == "build-boxes":
        ...
        import polars as pl
        from cfb_model_build.pregame_wp.training import filter_outliers, save_pgwp_model, train_pgwp_model
