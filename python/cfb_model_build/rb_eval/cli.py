...
Usage:
  uv run python -m cfb_model_build.rb_eval features   --final-dir cfb/json/final --out cfb/rb_eval/rush_plays.parquet
  uv run python -m cfb_model_build.rb_eval aggregate  --plays cfb/rb_eval/rush_plays.parquet --out cfb/rb_eval/rusher_seasons.parquet
  uv run python -m cfb_model_build.rb_eval train      --seasons cfb/rb_eval/rusher_seasons.parquet --out cfb/rb_eval/
  uv run python -m cfb_model_build.rb_eval validate   --loso cfb/rb_eval/xrepa_loso.parquet --out cfb/rb_eval/
  uv run python -m cfb_model_build.rb_eval figures    --table cfb/rb_eval/calibration.parquet --out cfb/rb_eval/
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.cmd == "features":
        ...
        import polars as pl
        from cfb_model_build.rb_eval.aggregate import build_rusher_seasons
        ...
        import polars as pl
        from cfb_model_build.rb_eval.aggregate import build_model_data
        from cfb_model_build.rb_eval.train import loso_cv, save_model, train_xrepa
        ...
        from cfb_model_build.rb_eval.validate import weighted_cal_error, weighted_r2
