...
def write_xrepa_calibration(
    ...
    """
    try:
        from cfb_model_build.model_training.figures import write_calibration as _wc
    except ImportError as e:
        raise ImportError(
            "cfb_model_build.model_training.figures (plotnine) required for figure rendering. "
