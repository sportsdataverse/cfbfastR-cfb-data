"""Builder: ESPN CFB betting lines.
...
Twin of ``R/espn_cfb_09_betting_creation.R`` -- the number is the cross-language
...
Example:
    One season::
        ...
        uv run python python/espn_cfb_09_betting_creation.py -s 2026 -e 2026
"""
