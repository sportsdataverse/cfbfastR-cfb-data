"""Builder: ESPN CFB ESPN power index.
...
Twin of ``R/espn_cfb_12_power_index_creation.R`` -- the number is the cross-language
...
Example:
    One season::
        ...
        uv run python python/espn_cfb_12_power_index_creation.py -s 2026 -e 2026
"""
