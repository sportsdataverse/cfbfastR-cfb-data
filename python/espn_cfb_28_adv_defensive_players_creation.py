"""Builder: ESPN CFB advanced box: defensive players.
...
Example:
    One season::
        ...
        uv run python python/espn_cfb_28_adv_defensive_players_creation.py -s 2026 -e 2026
"""
