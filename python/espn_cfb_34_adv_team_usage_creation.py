"""Builder: ESPN CFB usage box: team situational efficiencies.
...
Example:
    One season::
        ...
        uv run python python/espn_cfb_34_adv_team_usage_creation.py -s 2026 -e 2026
"""
