"""Builder: ESPN CFB special teams: kick and punt returners.
...
Example:
    One season::
        ...
        uv run python python/espn_cfb_38_adv_st_returners_creation.py -s 2026 -e 2026
"""
