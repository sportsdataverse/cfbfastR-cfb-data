"""Builder: ESPN CFB special teams: punt and field-goal blocks by player.
...
Example:
    One season::
        ...
        uv run python python/espn_cfb_39_adv_st_blocks_creation.py -s 2026 -e 2026
"""
