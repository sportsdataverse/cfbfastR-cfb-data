...
betting lines, game meta. Reads TWO seasons of the ``cfbfastR_cfb_pbp``
release (the prior season feeds ``prev_*``), CFBD ``/games`` for both and CFBD
``/lines`` (needs ``CFBD_API_KEY``).
