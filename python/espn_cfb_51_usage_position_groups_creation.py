"""Builder: ESPN CFB season leaderboard: position-group usage.
...
Example:
    One season::
        ...
        uv run python python/espn_cfb_51_usage_position_groups_creation.py -s 2026 -e 2026
"""
