"""Builder: ESPN CFB season leaderboard: tackle share by position group.
...
Example:
    One season::
        ...
        uv run python python/espn_cfb_53_usage_position_group_tackles_creation.py -s 2026 -e 2026
"""
...
DATASET = "usage_position_group_tackles"
